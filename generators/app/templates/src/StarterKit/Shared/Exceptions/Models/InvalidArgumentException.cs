...
namespace StarterKit.Shared.Exceptions.Models
{
	...
	{
		public InvalidArgumentException(string message = Defaults.InvalidationArgumentException.Title,
			string code = Defaults.InvalidationArgumentException.Code, Exception exception = null,
