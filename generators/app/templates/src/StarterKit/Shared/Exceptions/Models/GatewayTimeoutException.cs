...
namespace StarterKit.Shared.Exceptions.Models
{
	public class GatewayTimeoutException : Digipolis.Errors.Exceptions.BaseException
	{
		...
		public GatewayTimeoutException(string message = Defaults.GatewayTimeoutException.Title,
			string code = Defaults.GatewayTimeoutException.Code, Exception ex = null,
