namespace StarterKit.Shared.Constants
{
  ...
  public class LogSettingsEnvVariableKey
  {
    ...
    public const string RequestLogging_Incoming_AllowedRequestHeaders = "LOGSETTINGS_REQUESTLOGGING_INCOMING_ALLOWEDREQUESTHEADERS";
    public const string RequestLogging_Incoming_AllowedResponseHeaders = "LOGSETTINGS_REQUESTLOGGING_INCOMING_ALLOWEDRESPONSEHEADERS";
    ...
    public const string RequestLogging_Outgoing_AllowedRequestHeaders = "LOGSETTINGS_REQUESTLOGGING_OUTGOING_ALLOWEDREQUESTHEADERS";
    public const string RequestLogging_Outgoing_AllowedResponseHeaders = "LOGSETTINGS_REQUESTLOGGING_OUTGOING_ALLOWEDRESPONSEHEADERS";
  }
}
