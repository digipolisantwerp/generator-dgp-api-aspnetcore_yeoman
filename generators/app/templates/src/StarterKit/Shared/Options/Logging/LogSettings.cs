...
namespace StarterKit.Shared.Options.Logging
{
  public class LogSettings : SettingsBase
  {
    ...
    private void LoadFromConfigSection(IConfiguration section)
    {
      ...
      RequestLogging.AllowedIncomingRequestHeaders = GetStringsFromConfigSection(section, "RequestLogging:AllowedIncomingRequestHeaders", this.RequestLogging.AllowedIncomingRequestHeaders);
      RequestLogging.AllowedIncomingResponseHeaders = GetStringsFromConfigSection(section, "RequestLogging:AllowedIncomingResponseHeaders", this.RequestLogging.AllowedIncomingResponseHeaders);
      RequestLogging.AllowedOutgoingRequestHeaders = GetStringsFromConfigSection(section, "RequestLogging:AllowedOutgoingRequestHeaders", this.RequestLogging.AllowedOutgoingRequestHeaders);
      RequestLogging.AllowedOutgoingResponseHeaders = GetStringsFromConfigSection(section, "RequestLogging:AllowedOutgoingResponseHeaders", this.RequestLogging.AllowedOutgoingResponseHeaders);
    }
    ...
    private void OverrideFromEnvironmentVariables(IHostEnvironment environment)
    {
      ...
      if (bool.TryParse(Environment.GetEnvironmentVariable(LogSettingsEnvVariableKey.RequestLogging_LogPayloadOnError),
      ...
      if (bool.TryParse(Environment.GetEnvironmentVariable(LogSettingsEnvVariableKey.RequestLogging_Incoming_Enabled),
          out bool incomingRequestLoggingEnabled))
      {
        RequestLogging.IncomingEnabled = incomingRequestLoggingEnabled;
      }
      
      var allowedIncomingRequestHeaders = Environment.GetEnvironmentVariable(LogSettingsEnvVariableKey.RequestLogging_Incoming_AllowedRequestHeaders);
      ...
      var allowedIncomingResponseHeaders = Environment.GetEnvironmentVariable(LogSettingsEnvVariableKey.RequestLogging_Incoming_AllowedResponseHeaders);
      ...
      if (bool.TryParse(Environment.GetEnvironmentVariable(LogSettingsEnvVariableKey.RequestLogging_OutgoingEnabled),
          out bool outgoingRequestLoggingEnabled))
      {
        RequestLogging.OutgoingEnabled = outgoingRequestLoggingEnabled;
      }

      var allowedOutgoingRequestHeaders = Environment.GetEnvironmentVariable(LogSettingsEnvVariableKey.RequestLogging_Outgoing_AllowedRequestHeaders);
      ...
      var allowedOutgoingResponseHeaders = Environment.GetEnvironmentVariable(LogSettingsEnvVariableKey.RequestLogging_Outgoing_AllowedResponseHeaders);
